...
class PokeCardsModel {
    ...
    function insertCard($type, $hp, $stage, $attackName1, $attackDesc1, $attackDamage1, $attackEnergies1, $attackName2, $attackDesc2, $attackDamage2, $attackEnergies2, $hasPokePower, $pokePowerName, $pokePowerDesc, $weakness, $resistance, $retreatCost, $pokedexInfo, $card_id) {
        $query = $this->db->prepare('INSERT INTO pokemon_card (type, hp, stage, attackName1, attackDesc1, attackDamage1, attackEnergies1, attackName2, attackDesc2, attackDamage2, attackEnergies2, hasPokePower, pokePowerName, pokePowerDesc, weakness, resistance, retreatCost, pokedexInfo, card_id) VALUES (:type, :hp, :stage, :attackName1, :attackDesc1, :attackDamage1, :attackEnergies1, :attackName2, :attackDesc2, :attackDamage2, :attackEnergies2, :hasPokePower, :pokePowerName, :pokePowerDesc, :weakness, :resistance, :retreatCost, :pokedexInfo, :card_id)');
    ...
    function deleteCard($id) {
        $query = $this->db->prepare('DELETE FROM pokemon_card WHERE id = :id');
        $query->execute(['id' => $id]);
    }
