...
class PokeCardsModel {
    ...
    function getACardByCardId($card_id) {
        $query = $this->db->prepare('SELECT * FROM pokemon_card WHERE card_id = :card_id');
    ...
    function updateCard($card_id, $type, $hp, $stage, $evolvesFrom, $attackName1, $attackDesc1, $attackDamage1, $attackEnergies1, $attackName2, $attackDesc2, $attackDamage2, $attackEnergies2, $hasPokePower, $pokePowerName, $pokePowerDesc, $weakness, $resistance, $retreatCost, $pokedexInfo) {
        $query = $this->db->prepare('UPDATE pokemon_card SET type = :type, hp = :hp, stage = :stage, evolvesFrom = :evolvesFrom, attackName1 = :attackName1, attackDesc1 = :attackDesc1, attackDamage1 = :attackDamage1, attackEnergies1 = :attackEnergies1, attackName2 = :attackName2, attackDesc2 = :attackDesc2, attackDamage2 = :attackDamage2, attackEnergies2 = :attackEnergies2, hasPokePower = :hasPokePower, pokePowerName = :pokePowerName, pokePowerDesc = :pokePowerDesc, weakness = :weakness, resistance = :resistance, retreatCost = :retreatCost, pokedexInfo = :pokedexInfo WHERE card_id = :card_id');
        $result = $query->execute(['type' => $type, 'hp' => $hp, 'stage' => $stage, 'evolvesFrom' => $evolvesFrom, 'attackName1' => $attackName1, 'attackDesc1' => $attackDesc1, 'attackDamage1' => $attackDamage1, 'attackEnergies1' => $attackEnergies1, 'attackName2' => $attackName2, 'attackDesc2' => $attackDesc2, 'attackDamage2' => $attackDamage2, 'attackEnergies2' => $attackEnergies2, 'hasPokePower' => $hasPokePower, 'pokePowerName' => $pokePowerName, 'pokePowerDesc' => $pokePowerDesc, 'weakness' => $weakness, 'resistance' => $resistance, 'retreatCost' => $retreatCost, 'pokedexInfo' => $pokedexInfo, 'card_id' => $card_id]);
        return $query;
    }
}